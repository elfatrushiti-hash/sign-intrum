...
export default function KPISection({ data }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 h-full">
      {cards.map((c,i) => (
        <div key={i} className="bg-intrumPurple text-white p-4 rounded-lg shadow cursor-pointer hover:scale-105 transform transition flex flex-col justify-between h-full"
